export type LoggingLevel = 'verbose' | 'warnings' | 'silent';
...
export interface GenModelOptions {
    ...
    skipScan: string | string[]; // don't scan file or folder (relative to csPath)
    skipScanRe: string | string[]; // don't scan file or folder (relative to csPath)
    scanRe: string | string[]; // don't scan file or folder (relative to csPath)
    // /**
    ...
    //  */
    // prefix?: /* The prefix to apply to the generated component selector. */ any | any /* html-selector */;
    // /**
